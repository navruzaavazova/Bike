...
class _CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(0, size.height * 0.03762311, size.width * 0.02558374, 0,
        size.width * 0.05714286, 0);
    path.lineTo(size.width * 0.9428571, 0);
    path.cubicTo(size.width * 0.9744171, 0, size.width,
        size.height * 0.03762315, size.width, size.height * 0.08403361);
    path.lineTo(size.width, size.height * 0.7653613);
    path.cubicTo(
        size.width,
        size.height * 0.8080798,
        size.width * 0.9782057,
        size.height * 0.8440000,
        size.width * 0.9493457,
        size.height * 0.8488487);
    path.lineTo(size.width * 0.06363114, size.height * 0.9977101);
    path.cubicTo(size.width * 0.02972257, size.height * 1.003408, 0,
        size.height * 0.9644076, 0, size.height * 0.9142185);
